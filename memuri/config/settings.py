# -*- coding: utf-8 -*-
"""
Django settings for memuri project.
...
class Common(Configuration):
    ...
    DATABASES = values.DatabaseURLValue('postgres://localhost/memuri_project')
...
class Production(Common):
    ...
    DEFAULT_FROM_EMAIL = values.Value(
            'memuri <memuri-noreply@memuri.knitatoms.net>')
