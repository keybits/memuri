...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bookmarks_bookmark', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bookmarks', to=orm['users.User'])),
        ))
        db.send_create_signal('bookmarks', ['Bookmark'])

        # Adding M2M table for field tags on 'Bookmark'
        m2m_table_name = db.shorten_name('bookmarks_bookmark_tags')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('bookmarks_bookmark_tags'))
    ...
    models = {
        ...
        'bookmarks.bookmark': {
            'Meta': {'ordering': "['-date_created']", 'object_name': 'Bookmark'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bookmarks'", 'to': "orm['users.User']"}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'symmetrical': 'False', 'to': "orm['bookmarks.Tag']"}),
