...
.. code-block:: bash
    ...
    heroku run python memuri_project/manage.py syncdb --noinput --settings=config.settings
    heroku run python memuri_project/manage.py migrate --settings=config.settings
    heroku run python memuri_project/manage.py collectstatic --settings=config.settings
